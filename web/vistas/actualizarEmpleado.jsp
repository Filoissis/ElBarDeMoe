<%-- 
    Document   : index
    Created on : 28/07/2022, 06:15:33 PM
...
<html>
    <head>
        ...
        <title>Sistema SAIB| Empleado</title>
            ...
            <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10 col-md-5 ">
                            <div class="btn-group pull-right">
                                <a href="srvEmpleado?accion=listarEmpleados" class="btn btn-default">
                ...
                <section class="content">
                    <div class="box">
                        ...
                        <form class="form-horizontal" action="srvEmpleado?accion=actualizarEmpleado" method="post">
                            <input type="hidden" name="hCodigo" value="${empleado.idEmpleado}">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: Juan" name="txtNombre" maxlength="50"
                                               value="${empleado.nombreEmpleado}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Apellido Empleado</label>
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: Rodriguez" name="txtApellido" maxlength="50"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: 79654321" name="txtDocumento" maxlength="10"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: 262 7700" name="txtTelefono" maxlength="10"
                                               value="${empleado.telefonoEmpleado}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: 1000000" name="txtSalario" maxlength="7"
                            ...
                            <div class="box-footer">
                                ...
                                <a href="srvEmpleado?accion=listarEmpleados" type="reset" class="btn btn-danger">
