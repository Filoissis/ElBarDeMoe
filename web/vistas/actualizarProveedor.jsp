<%-- 
    Document   : index
    Created on : 28/06/2022, 06:15:33 PM
...
<html>
    <head>
        ...
        <title>Sistema SAIB| Proveedor</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10 col-md-5 ">
                            <div class="btn-group pull-right">
                                <a href="srvProveedor?accion=listarProveedores" class="btn btn-default">
                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            <i class="fa fa-edit"></i> <h3 class="box-title">Actualizar Datos del Proveedor</h3>  
                        </div>
                        <form class="form-horizontal" action="srvProveedor?accion=actualizarProveedor" method="post">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: Compañía" name="txtNombre" maxlength="50"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: Cll 100 # ..." name="txtDireccion" maxlength="25"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: 2627700" name="txtTelefono" maxlength="7"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: 46826521" name="txtNIT" maxlength="8"
                            ...
                            <div class="box-footer">
                                ...
                                <a href="srvProveedor?accion=listarProveedores" type="reset" class="btn btn-danger">
