                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="srvProducto?accion=listarProductosVendedor"><i class="fa fa-cube"></i>Productos</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                                ...
                                <table class="table table-bordered table-striped dataTable table-hover" id="tablaProductos" class="display">
                                    ...
                                    <c:forEach var="prodc" items="${productos}" varStatus="iteracion">                                                    
                                        <tr>
                                            ...
                                            <c:if test="${prodc.inventarioProducto > 10}">
                                                <td><span class="badge bg-green active">${prodc.inventarioProducto}</span></td> 
                                            </c:if>
                                            <c:if test="${prodc.inventarioProducto <= 10}">
                                            <td><span class="badge bg-red active">${prodc.inventarioProducto}</span></td> 
                                            </c:if>
