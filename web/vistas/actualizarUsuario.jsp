...
<html>
    <head>
        ...
        <title>Sistema SAIB| Usuario</title>
                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            <i class="fa fa-edit"></i> <h3 class="box-title">Actualizar Datos de Usuario</h3>  
                        </div>
                        <form class="form-horizontal" action="srvUsuario?accion=actualizarUsuario" method="post">
                            <input type="hidden" name="hCodigo" value="${usuario.idUsuario}">
                            <div class="box-body">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <select class="form-control"  name="cboCargo" autofocus=""  required="">
                                            ...
                                            <c:forEach items="${cargos}" var="carg">
                                                <option value="${carg.idCargo}"  
                                                        <c:if test="${carg.idCargo == 
                                                                      usuario.cargo.idCargo}">
                                                              selected
                                                        </c:if>
                                                        >${carg.nombreCargo}</option>
                                            </c:forEach>
                                        </select>
                                    </div>                                  
                                </div>
                            ...
                            <div class="box-footer">
                                ...
                                <a href="srvUsuario?accion=listarUsuarios" type="reset" class="btn btn-danger">
