    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <a href="srvProveedor?accion=nuevoProveedor" class="btn btn-success">
                                ...
                                <table class="table table-bordered table-striped dataTable table-hover" id="tablaProveedores" class="display">
                                    ...
                                    <c:forEach var="prov" items="${proveedores}" varStatus="iteracion">                                                    
                                        <tr>
                                            ...
                                            <td><a href="<c:url value="srvProveedor">
                                                ...
                                                <!-- ELIMINAR USUARIOS -->
                                                <input type="hidden" id="codigo" value="${prov.idProveedor}">
                                                <a id="deleteUser" href="<c:url value="srvProveedor">
