            ...
            <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10 col-md-5 ">
                            <div class="btn-group pull-right">
                                <a href="srvVenta?accion=listarVentasVendedor" class="btn btn-default">
                ...
                <section class="content">
                    <div class="box">
                        ...
                        <form class="form-horizontal" action="srvVenta?accion=registrarVentaVendedor" method="post" name="form1">
                            ...
                            <div class="box-footer">
                                <a href="<c:url value="srvVenta">
                                       <c:param name="accion" value="listarVentasVendedor" />
                                       <c:param name="idven" value="${vendedor.idUsuario}" />
                                   </c:url>" type="reset" class="btn btn-danger"><i class="fa-close red"></i>Cancelar</a>
